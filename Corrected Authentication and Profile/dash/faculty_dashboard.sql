...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2021 at 06:36 AM
...
INSERT INTO `faculty` (`Fac_ID`, `Name`, `email_id`, `qualification`, `position`, `interest`, `address`, `dept`, `mobile`) VALUES
('FAC0035', 'Ram Kumar S', 'ramkumar@gmail.com', 'B.Tech, M.Tech ', 'Assistant Professor', 'Image Processing, Data Mining', '106, Vartharaja layout, Gandhi Nagar, Trichy-65.', 'Computer Science', '9843249546'),
('FAC0036', 'Sujatha R', 'sujatha_r@gmail.com', 'M.Sc (Chemistry)', 'Associate Professor', 'Physical Chemistry of Polymer solutions', '86,Kammachi Amman layout, Gandhi Nagar, Madurai-23.', 'Chemistry', '9655449546'),
('FAC0037', 'Supriya K', 'k_supriya88@gmail.com', 'B.E, M.E', 'Assistant Professor', 'Machine Learning, Neural Networks', '86/56, Nehru Road, RK Nagar, Palakkad-23.', 'Computer Science', '9984324946'),
('FAC0038', 'Senthil Kumar M', 'senthil_kumar_m@gmail.com', 'Ph.D', 'Assistant Professor ', 'Cryptography, Web Security Development', '86/56, Shrivalli Apartments RKN Nagar, Chennai-23.', 'Web Security', '9655549546'),
('FAC0039', 'Kavitha R V', 'r_v_kavitha@yahoo.in', 'M.Sc, Ph.D', 'Assistant Professor', 'Video Analytics, Big Data Analytics, Intrusion Det', '86/56, Mayura Apartments VK Nagar, KannyaKumari-23.', 'Computer Science', '9655649546'),
('FAC0040', 'Magesh V', 'maghesh_vishnu@gmail.com', 'B.Tech, M.E, Ph.D', 'Research Supervisor,', 'Distributed Computing, Medical Informatics, Mentor', '86/56, Balan Road, R.K.N Nagar, Chennai-25.', 'Computer Science', '7373049546'),
('FAC0041', 'Shri Ram V', 'shri_v_ram1984@gmail.com', 'B.Tech, M.Tech', 'Assistant Professor', 'IoT, Artifical Intelligence', '45, Bangalore Road, Vagur Nagar, Mettupalayam-33.', 'Computer Science', '9145674127'),
('FAC0042', 'Bharathi D', 'd_bharathi@gmail.com', 'B.Tech, M.Tech', 'Assistant Professor', 'Image Processing', '45, Bannare Road, Vagur Nagar, Hosur-33.', 'Computer Science', '8689459655'),
('FAC0043', 'Raghesh K', 'krishnan_raghesh@gmail.com', 'M.Tech, Ph.D', 'Assistant Professor', 'Cementitious composites, High performance and Light Construction', '45, Shri Vatsa Villa, Thudiyalur, Coimbatore-33.', 'Civil Engineering', '8207204356'),
('FAC0044', 'Archana R', 'rarchana@gmail.com', 'M.Phil, M.A', 'Associate Professor', 'English Language Teaching, Literature, Religion in Literature and Poetry', '45,Kishore Street, KK Pudur Post, Saibaba Colony, Coimbatore-22.', 'English and Humanities', '8674955355');
